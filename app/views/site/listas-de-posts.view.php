        ...
        <div class="cardContainer">
            ...
            <div class="blurrableDiv">
                ...
                <div class="absoluteTitleContainer">
                    <h1>Ada Lovelace Lorem Ipsum</h1>
                </div>
                <div class="previewContainer">
                    <h2>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec interdum rutrum lectus facilisis
                        ultricies. Aenean lacinia sem mauris, eu feugiat enim tempus eu. Donec mattis ligula eu lacus
                        faucibus placerat. Etiam rhoncus pellentesque nisl, sit amet finibus erat egestas eu. Ut sed
                        erat fringilla, gravida nulla id, cursus turpis. Nunc efficitur, dui gravida condimentum
                        malesuada, urna ligula tincidunt urna, ac maximus nisl risus vitae nibh. Mauris gravida, dui
                        quis ullamcorper faucibus, sapien lacus porta sem, et laoreet augue nisl non purus.</h2>
                </div>
            </div>
        </div>
